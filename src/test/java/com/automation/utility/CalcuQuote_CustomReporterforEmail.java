...
public class CalcuQuote_CustomReporterforEmail extends CalcuQuote_CustomReporterListener {
    public static String browsername;
	private static final Logger L = Logger
			.getLogger(CalcuQuote_CustomReporterListener.class);
	...
	public CalcuQuote_CustomReporterforEmail() {
		super();
...
//	}
	...
	private void startResultSummaryTable(String style) {  //5.2.1
		...
		m_out.println("<tr><td bgcolor='white' colspan='4'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='250px' src='https://triveniglobalsoft.com/content/image/logo.png\r\n" + 
				"'/></center>"
		...
		m_out.println("<tr><td colspan='4'>Overall test suite completion : <b>"
				...
				+ com.automation.init.CalcuQuote_SeleniumInit.browserVersion +  "</b><br/>OS: <b>"
...
/*	@SuppressWarnings("unused")
	...
	protected void endHtml(PrintWriter out) {
		...
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='4'><center><b><i>Report customized by Triveni Global Software Services LLP </i><b><center></center></b></b></center></td></tr>");
