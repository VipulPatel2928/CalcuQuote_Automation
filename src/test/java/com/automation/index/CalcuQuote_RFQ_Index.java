...
public class CalcuQuote_RFQ_Index extends CalcuQuote_SeleniumInit{
	...
	public void RFQ_TestCase_01(){	
		 ...
		 * LogClass.logstep(report_msg); LogClass.logExtent(report_msg); if
		 * (packageVerification.CalcuQuote_login_verification()) {
		 * LogClass.logveri("-----> Verified User has Logged in Successfully <-----");
		 * LogClass.logExtent("-----> Verified User has Logged in Successfully <-----");
		 * LogClass.AssertPassed(); Assert.assertTrue(true); } else {
		 * LogClass.logveri("-----> Verified User has Not Logged in Successfully <-----"
		 * ); LogClass.
		 * logExtent("-----> Verified User has Not Logged in Successfully <-----");
